                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                    ...
                                    <p className='text-xl text-slate-600 mb-2'>Changes History</p>
                                    <ul className='list-decimal'>
                                        {data.completedBy.map( activityLog => (
                                            <li key={activityLog._id} className='ml-4'>
                                                <span className='font-bold text-slate-600'>
                                                    {statusFormattedTitles[activityLog.status]} by:
                                                </span>{' '}
                                    ...
                                    <div className='my-5 space-y-3'>
                                        <label className='font-bold'>Actual State: {data.status}</label>
                                        ...
                                        >
                                            {Object.entries(statusFormattedTitles).map(([key, value]) => (
