    ...
    return (
      <>
        ...
        {data.length ? (
          <ul
            role="list"
            className="divide-y divide-gray-100 border border-gray-100 mt-10 bg-white shadow-lg mb-20"
          >
            {data.map((project) => (
              <li
                key={project._id}
                  ...
                  <div className="min-w-0 flex-auto space-y-2">
                    <div className="mb-2">
                      { isManager(project.manager, user._id) ? 
                        <p className="font-bold text-xs uppercase bg-yellow-50 text-yellow-500 border-2 border-yellow-500 rounded-lg inline-block py-1 px-5">Manager</p> : 
          ...
          <p className="text-center text-lg py-16 font-semibold">
            There are no projects yet, create a new one {""}
            <Link
              to="/projects/create"
